...
settings <- yaml::read_yaml('/data/local/buyar/arcas/pancancer_multiomics_manuscript/results/hallmark_genes/settings.yaml')
...
FigureFolder <- '/data/bimsbstatic/public/akalin/buyar/manuscript_figures_arcas/test'
