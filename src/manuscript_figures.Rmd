...
ggsave(paste0('Figure', fig_count, '.pancancer_cancer_type_prediction.pdf'), 
...
ggsave(paste0('Figure', fig_count, '.cluster_stability_metrics.pdf'), 
       plot = Fig, units = 'in', 
       width = 10, height = 8)
```
...
fig_count <- fig_count + 1
ggsave(filename = paste0('Figure', fig_count, '.surv.Cindex_improv.hazard_ratio.pdf'), 
...
fig_count <- fig_count + 1
ggsave(filename = paste0('Figure', fig_count, '.clinical_factors.LFs.pdf'), 
       plot = Fig, units = 'in', width = 12, height = 9)
Figures[[fig_count]] <- Fig
```
...
fig_count <- fig_count + 1
ggsave(filename = paste0("Figure", fig_count, '.MSI.status.pdf'), 
...
fig_count <- fig_count + 1
ggsave(filename = paste0('Figure', fig_count, '.semi_supervised.clustering.', experiment,'.pdf'), 
       Fig, units = 'in', 
       width = 10, height = 12)
...
fig_count <- fig_count + 1
ggsave(filename = paste0('Figure', fig_count, '.semi_supervised.prognostic.clustering.', experiment,'.pdf'), 
       plot = Fig, units = 'in', 
       width = 10, height = 12)
