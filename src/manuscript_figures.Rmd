...
projDir <- '/data/local/buyar/arcas/pancancer_multiomics_manuscript/results/immunotherapy_response/Mariathasan_et_al'
settings_imtrp <- yaml::read_yaml(file.path(projDir, 'settings.yaml'))
gex_all <- readRDS(file.path(projDir, 'mariathasan.gex.all_genes.normalised.RDS'))
human_gene_signatures <- readRDS(file.path(projDir, 'human_gene_signatures.RDS'))
