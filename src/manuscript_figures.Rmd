...
```{r clinical_survival_factors, fig.width=12, fig.height=8}
...
SuppLegends[[supFig_count]] <- "Survival curves adjusted for tumor stage + age + gender based on a cutpoint of 
top survival-associated LF per cancer cohort."
